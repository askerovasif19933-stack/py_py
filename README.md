...
Перейти в папку tz_alchemi

1. Создание базы данных, запустить файл base_tz.py:

2. Обработка документов, запустить файл main:
...
В решение используеться SQLAlchemy ORM обрашение к базе данных как к обьектам python.
